...
const NewCollection = () => {
    return (
        <section className="flex flex-col md:pt-12 pt-14 relative">
            <div className="flex md:px-10 px-2 md:gap-8 items-center max-md:flex-col">
                <h1 className="mainHeading font-Bropella">New</h1>
                <p className="md:w-[40%] font-serif max-md:mb-6 font-bold md:text-xl text-base text-center">
                ...
                <div
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-200 font-thin font-serif">
