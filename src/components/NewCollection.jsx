    ...
    return (
        <section className="flex flex-col md:pt-12 pt-32 relative">
            <div className="flex md:px-10 px-2 md:gap-8 gap-4 md:items-center justify-between max-md:flex-col">
                <AnimatedText className="mutligrateintAnimatedText font-playfair lg:text-7xl text-5xl ">New</AnimatedText>
                <AnimatedText className="md:w-[40%] font-lora max-md:mb-6 md:text-xl text-[1.7rem] md:text-center" delay={0.2}>
                    Zale's Combination of Statement and simplistic style helps create a look that's as unique as you are
                </AnimatedText>
                <div className="flex md:justify-end justify-center">
                    <AnimatedText className="mutligrateintAnimatedText font-playfair lg:text-7xl text-5xl " delay={0.4}>Collection</AnimatedText>
                </div>
            </div>
                ...
                <div
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        <div className="flex flex-col gap-2">
                            <AnimatedText className="text-gray-400 font-lora">From: <span className="text-white">Classic Set</span></AnimatedText>
                            <AnimatedText className="text-white text-3xl font-playfair" delay={0.1}>Introducing The Zales Lesedi La Rona</AnimatedText>
                            <AnimatedText className="uppercase text-[#5b3e3e] font-lora" delay={0.2}>A record-breaking jewel</AnimatedText>
                            <AnimatedText className="text-gray-200/65 font-thin text-lg font-lora" delay={0.3}>
                        ...
                        <div className="flex flex-col gap-1 mt-4">
                            <AnimatedText className="text-gray-300 font-lora" delay={0.4}>Expert Analysis</AnimatedText>
                            <AnimatedText className="text-gray-300 font-lora" delay={0.5}>A Sensational Result</AnimatedText>
                        </div>
                    </div>
                </div>
                <div
